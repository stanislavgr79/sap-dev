    ...
    if (
        ...
        var q,
                    ...
                    for (var o = 0; n > o; o++)
                        (l = m[o]),
                            e.push({
                                ...
                                minw:
                                    l.match(/\(min\-width:[\s]*([\s]*[0-9\.]+)(px|em)[\s]*\)/) &&
                                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                                maxw:
                                    l.match(/\(max\-width:[\s]*([\s]*[0-9\.]+)(px|em)[\s]*\)/) &&
                                    parseFloat(RegExp.$1) + (RegExp.$2 || ""),
                            });
                }
                u();
            ...
            u = function (a) {
                var b = "clientWidth",
                    h = d[b],
                    k = ("CSS1Compat" === c.compatMode && h) || c.body[b] || h,
                    m = {},
                    n = l[l.length - 1],
                    o = new Date().getTime();
                if (a && q && i > o - q)
                ...
                for (var p in e)
                    if (e.hasOwnProperty(p)) {
                        var v = e[p],
                            ...
                            z = null === x,
                            A = "em";
                        w && (w = parseFloat(w) * (w.indexOf(A) > -1 ? t || s() : 1)),
                            x && (x = parseFloat(x) * (x.indexOf(A) > -1 ? t || s() : 1)),
                            (v.hasquery && ((y && z) || !(y || k >= w) || !(z || x >= k))) ||
                            (m[v.media] || (m[v.media] = []), m[v.media].push(f[v.rules]));
                    }
                for (var B in g)
                    g.hasOwnProperty(B) &&
                        g[B] &&
                ...
                for (var C in m)
                    if (m.hasOwnProperty(C)) {
                        ...
                        (D.type = "text/css"),
                            (D.media = C),
                            j.insertBefore(D, n.nextSibling),
                            D.styleSheet
                                ? (D.styleSheet.cssText = E)
                                : D.appendChild(c.createTextNode(E)),
                            g.push(D);
                    }
            },
            v = function (a, b) {
